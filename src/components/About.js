...
export default function About() {
  return (
    <section className="sticky top-20 self-start hidden md:block" style={{ maxWidth: "180px" }}>
      ...
      <p className="text-sm text-gray-500">Developer & CRO Specialist who loves creating enticing experiences | Employed at Storm Digital, part of Accenture Interactive</p>
    </section>
  )
}
